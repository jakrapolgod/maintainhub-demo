        ...
        <section className="rounded-xl border bg-card p-4">
          ...
          {isForbidden && (
            <p className="text-sm text-red-600 mt-3">
              Report generation is available to Managers and Admins only.
            </p>
          )}
          ...
          {result && (
            <div className="mt-4 rounded-md border bg-muted/30 p-3 text-sm flex items-center justify-between">
              <span>
                Report <span className="font-mono">{result.docNumber}</span> generated successfully.
              </span>
          ...
          <div className="overflow-x-auto rounded-xl border bg-card">
            <table className="w-full text-sm">
              <thead className="border-b bg-muted/40">
                <tr>
                  {['Doc Number', 'Period', 'Generated By', 'Created', 'PDF'].map((h) => (
                    <th
                      key={h}
                  ...
                  rows.map((r) => (
                    <tr key={r.id} className="border-b last:border-0 hover:bg-muted/20">
                      ...
                      <td className="px-4 py-3">
                        {r.periodFrom.slice(0, 10)} to {r.periodTo.slice(0, 10)}
                      </td>
