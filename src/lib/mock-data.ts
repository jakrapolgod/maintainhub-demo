...
export const assets: Asset[] = [
  ...
  {
    id: 'a4',
    name: 'Cooling Tower CT-004',
    tag: 'CT-004',
    status: 'ACTIVE',
    criticality: 'C',
    location: 'External – North Yard',
...
export const workOrders: WorkOrder[] = [
  {
    ...
    dueDate: '2026-05-23',
    description:
      'Pump P-001 mechanical seal is showing visible leakage at the stuffing box. Coolant is pooling on the base plate. Seal must be replaced before the next production run to prevent pump failure and contamination.',
  },
  {
    id: 'wo2',
    title: 'Lubricate drive belt',
    assetId: 'a3',
    status: 'OPEN',
    priority: 'MEDIUM',
    assignedTo: 'u3',
    ...
    dueDate: '2026-05-30',
    description:
      'Conveyor CB-003 drive belt tension and lubrication are due per the quarterly schedule. Inspect for wear, apply approved belt dressing, and re-tension to spec (± 5 mm deflection).',
  },
  {
    id: 'wo3',
    title: 'Inspect pressure relief valve',
    assetId: 'a2',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    assignedTo: 'u3',
    ...
    dueDate: '2026-05-25',
    description:
      'Compressor AC-002 pressure relief valve (PRV-12) failed its last bench test at 85 % of set pressure. Disassemble, inspect spring and seat, recalibrate to 150 psi, and document results.',
  },
  {
    id: 'wo4',
    ...
    dueDate: '2026-05-28',
    description:
      'Cooling Tower CT-004 condenser coils have accumulated scale and biological growth reducing heat-transfer efficiency by an estimated 18 %. Chemical flush and high-pressure rinse required.',
  },
  {
    id: 'wo5',
    title: 'Load test under full capacity',
    assetId: 'a5',
    status: 'OPEN',
    priority: 'HIGH',
    assignedTo: 'u2',
    ...
    dueDate: '2026-06-01',
    description:
      'Generator G-001 is scheduled for its semi-annual full-load test (100 % rated kVA for 2 hours). Record voltage, frequency, oil pressure, and temperature at 30-min intervals per IEC 60034-2.',
  },
  {
    id: 'wo6',
    title: 'Replace air filter cartridge',
    assetId: 'a2',
    status: 'COMPLETED',
    priority: 'LOW',
    assignedTo: 'u3',
    ...
    description:
      'Compressor AC-002 inlet air filter cartridge has reached its 500-hour replacement interval. Replace with OEM part #AC-FILTER-02 and reset the hour meter.',
    resolution:
      'Filter cartridge replaced with OEM part #AC-FILTER-02. Hour meter reset to zero. Differential pressure across new filter confirmed at 0.4 kPa. No issues found.',
  },
  {
    id: 'wo7',
    ...
    description:
      'Pump P-001 ultrasonic flow sensor FS-07 is reading 6 % above the reference meter. Recalibrate per manufacturer procedure and update the SCADA tag offset.',
    resolution:
      'Flow sensor FS-07 recalibrated using portable reference meter. Zero and span adjusted; final deviation < 0.5 %. SCADA tag P001_FLOW offset updated from +6 % to 0 %.',
  },
  {
    id: 'wo8',
    title: 'Tighten conveyor tensioner',
    assetId: 'a3',
    status: 'COMPLETED',
    priority: 'HIGH',
    assignedTo: 'u3',
    ...
    description:
      'Conveyor CB-003 belt slipped under load twice in the past week, triggering belt-slip alarms. Inspect tail pulley tensioner, adjust take-up to restore 10 mm deflection, and check pulley lagging.',
    resolution:
      'Tail pulley take-up adjusted; deflection restored to 9.8 mm. Lagging showed 30 % wear — flagged for replacement in next planned shutdown. Belt-slip alarms cleared; conveyor ran 4 hours without incident.',
  },
]
...
export const pmSchedules: PMSchedule[] = [
  ...
  {
    id: 'pm2',
    title: 'Quarterly compressor overhaul',
    assetId: 'a2',
    type: 'CALENDAR',
    frequency: 'QUARTERLY',
    lastDone: '2026-02-01',
  ...
  {
    id: 'pm3',
    title: 'Monthly conveyor belt check',
    assetId: 'a3',
    type: 'METER',
    frequency: 'MONTHLY',
    lastDone: '2026-04-28',
  ...
  {
    id: 'pm7',
    title: 'Conveyor drive alignment',
    assetId: 'a3',
    type: 'CALENDAR',
    frequency: 'QUARTERLY',
    lastDone: '2026-02-20',
...
export const users: User[] = [
  {
    id: 'u1',
    name: 'Somchai Ratanaporn',
    email: 'somchai@maintainhub.th',
    role: 'ADMIN',
    avatarInitials: 'SR',
  },
  {
    id: 'u2',
    name: 'Nittaya Boonsri',
    email: 'nittaya@maintainhub.th',
    role: 'MANAGER',
    avatarInitials: 'NB',
  },
  {
...
// ── Notifications ─────────────────────────────────────────────────────────────
export type NotificationType = 'WO_OVERDUE' | 'PM_DUE' | 'SLA_BREACH' | 'LOW_STOCK' | 'WO_ASSIGNED'
