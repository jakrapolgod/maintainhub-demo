...
const INTEGRATIONS = [
  {
    ...
    name: 'Zapier',
    emoji: '⚡',
    desc: 'Automate workflows with 5,000+ apps',
    connected: false,
    type: 'api',
  },
  {
    ...
    name: 'Make',
    emoji: '🔧',
    desc: 'Build powerful automation scenarios',
    connected: true,
    type: 'api',
  },
  {
  ...
  },
  {
    ...
    emoji: '🔵',
    desc: 'Sync with Drive, Calendar, and Docs',
    connected: false,
    type: 'api',
  },
  {
    ...
    name: 'Microsoft 365',
    emoji: '🟦',
    desc: 'Connect with Teams, SharePoint, and more',
    connected: false,
    type: 'api',
  },
  {
    ...
    name: 'Azure AD',
    emoji: '☁️',
    desc: 'Single sign-on via Azure Active Directory',
    connected: false,
    type: 'api',
  },
] as const
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Connect MaintainHub to your existing tools and services.
        </p>
      </div>
...
const INITIAL_WEBHOOKS: Webhook[] = [
  ...
  {
    id: 'wh2',
    url: 'https://n8n.company.internal/webhook/maintainhub',
    events: 2,
    status: 'failure',
    lastAt: '1h ago',
  },
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Receive real-time HTTP notifications for CMMS events.
          </p>
        </div>
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Manage keys for programmatic access to MaintainHub.
        </p>
      </div>
      <Card>
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Configure SAML 2.0 or OIDC for your organization.
        </p>
      </div>
      <Card>
        <CardContent className="py-12 text-center text-sm text-muted-foreground">
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="space-y-4 p-4">
          ...
          <Button onClick={() => toast.success('Settings saved')} size="sm">
            Save changes
          </Button>
        </CardContent>
      </Card>
